 ...
 */
export function registerArtifactHooks(api: any, stateDir: string): void {
  ...
  try {
    ...
    setArtifactLogEnabled(cfg && typeof cfg === "object" && (cfg as any).logs === true);
  } catch {
...
function registerHooks(
  ...
  api.on("agent_turn_prepare", (_event: any, ctx: any) => {
    try {
