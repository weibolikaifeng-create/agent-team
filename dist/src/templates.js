export const TEMPLATES = [
    {
        ...
        modeInstruction: "Map phase: Run both search specialists in parallel, each focusing on different aspects/angles of the research topic (limit each to 3 sources). Reduce phase: Report writer combines all findings to create final comprehensive report.",
    },
    {
        id: "content-creation",
        ...
        modeInstruction: "Run workers sequentially: researcher → writer → reviewer. Each stage builds on the previous output.",
    },
    {
        id: "data-analysis",
        name: "Data Analysis",
        ...
        collaborationMode: "pipeline",
        modeInstruction: "Run workers sequentially: data-collector → analyst → visualizer. Each stage refines and builds on prior output.",
    },
    {
        ...
        collaborationMode: "mapreduce",
        modeInstruction: "Map phase: run researcher-a and researcher-b in parallel. Reduce phase: pass both outputs to analyst, then to reporter.",
    },
    {
        id: "brainstorm",
        name: "Brainstorm",
        ...
        collaborationMode: "mapreduce",
        modeInstruction: "Map phase: run optimist, critic, and pragmatist in parallel on the same task. Reduce phase: Leader synthesizes all perspectives.",
    },
];
/**
 ...
 */
export function scoreTemplate(template, task) {
...
export function rankTemplates(task) {
