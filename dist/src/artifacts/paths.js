...
export function artifactsManifestPath(stateDir, teamId) {
...
export function membersPath(stateDir, teamId) {
...
export function executionOutputDir(stateDir, teamId, executionId) {
