 ...
 */
let enabled = false;
export function setArtifactLogEnabled(on) {
    enabled = on === true;
}
export function isArtifactLogEnabled() {
    return enabled;
}
// ── size-based rotation ──────────────────────────────────────────────
...
export function slog(stateDir, teamId, msg) {
    if (!enabled)
        return;
...
export function glog(stateDir, msg) {
    if (!enabled)
        return;
