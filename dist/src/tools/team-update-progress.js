...
export function createTeamUpdateProgressTool(stateDir) {
    return {
        name: "team_update_progress",
        description: "Update progress tracking for team execution. Updates step statuses in todo.md and automatically inserts retry steps for failed items. Returns the updated todo.md content.",
        ...
        async execute(_toolCallId, params) {
            ...
            // Locate todo.md file
            const todoPath = path.join(stateDir, TEAM_DIR_NAME, team_id, EXECUTIONS_DIR, execution_id, TODO_FILE);
